...
from climax.prompt import PromptResult
...
def test_PromptResult_equality(string: str, value: object | None, exception: Exception | None) -> None:
    ...
    a_prompt_result: Final = PromptResult(string, value, exception)
    another_prompt_result: Final = PromptResult(string, value, exception)
...
def test_PromptResult_non_none_value_filed_with_truthy_exception_conversion_field_raises_ValueError(
    ...
    with raises(ValueError):
        PromptResult(string, value, exception)
