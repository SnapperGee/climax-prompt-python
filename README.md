...
[pipeline status shield]: https://img.shields.io/gitlab/pipeline-status/snap-climax/python-prompt?branch=dev&style=for-the-badge "Pipeline status"
[pipeline coverage shield]: https://img.shields.io/gitlab/pipeline-coverage/snap-climax/python-prompt?branch=dev&style=for-the-badge "Pipeline coverage"
[pipeline url]: https://gitlab.com/snap-climax/python-prompt/-/pipelines/dev/latest "Pipeline"
